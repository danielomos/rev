package com.revomvpandriodapp.app.modules.noactionordergasmandetail.`data`.model

import com.revomvpandriodapp.app.R
import com.revomvpandriodapp.app.appcomponents.di.MyApp
import kotlin.String

data class NoactionordergasmandetailModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var txtLanguage: String? = MyApp.getInstance().resources.getString(R.string.msg_delivering_weig)
  ,
  /**
   * TODO Replace with dynamic value
   */
  ...
  var txtDescription: String? =
      MyApp.getInstance().resources.getString(R.string.msg_accept_this_ref)
  ,
  /**
   * TODO Replace with dynamic value
   */
  var txtTeams: String? = MyApp.getInstance().resources.getString(R.string.lbl_reject)
  ,
  /**
   * TODO Replace with dynamic value
   */
  var txtDescriptionOne: String? =
      MyApp.getInstance().resources.getString(R.string.msg_this_order_is_p)
  ,
  /**
   * TODO Replace with dynamic value
   */
