package com.revomvpandriodapp.app.modules.confirmorderdetail.`data`.model

import com.revomvpandriodapp.app.R
import com.revomvpandriodapp.app.appcomponents.di.MyApp
import kotlin.String

data class ConfirmorderdetailModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var txtRetailerBusine: String? =
      MyApp.getInstance().resources.getString(R.string.msg_retailer_busine)
  ,
  /**
   * TODO Replace with dynamic value
   */
   ...
   * TODO Replace with dynamic value
   */
  var txtLanguage: String? = MyApp.getInstance().resources.getString(R.string.lbl_retailer_name)
  ,
  /**
   * TODO Replace with dynamic value
   */
  var txtInteresttoparOne: String? =
      MyApp.getInstance().resources.getString(R.string.msg_interest_to_par)
  ,
  /**
   * TODO Replace with dynamic value
  ...
  var txtLanguageOne: String? =
      MyApp.getInstance().resources.getString(R.string.lbl_delivery_weight)
  ,
  /**
   * TODO Replace with dynamic value
   */
